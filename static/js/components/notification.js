...
export default class Notification extends React.Component {
	...
	render() {
		return (
			<div className="notification" onClick={e => this.handleOpenClick()} style={{width: this.props.notificationOpen ? '3rem' : 'auto', height: this.props.notificationOpen ? '3.5rem' : 'auto', display: this.props.notification == '' ? 'none' : 'flex'}}>
